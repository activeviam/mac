...
public class NoWriteDatastoreServiceConfig extends ADatastoreServiceConfig {
	 ...
	 * constant below.
	 */
	protected static final Map<String, IStoreSecurity> storesSecurityMap = new HashMap<String, IStoreSecurity>() {
	 ...
	 * </p>
	 */
	protected static final IStoreSecurity defaultStoreSecurity = new IStoreSecurity() {
