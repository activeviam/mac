...
public class PivotFeederVisitor extends AFeedVisitor<Void> {
	 ...
	 *
	 * @param stat Entry point of the tree creation, should be
	 *              a {@link PivotMemoryStatisticConstants#STAT_NAME_MULTIVERSION_PIVOT}
	 *             , a {@link PivotMemoryStatisticConstants#STAT_NAME_PIVOT} or {@link
