 ...
 * <p>
 * Retrieving the authenticated user is done (and only works with)
...
public class QFSFormatter extends Formatter {
	...
	public QFSFormatter() {
		...
		this.logLoggerName = Boolean.parseBoolean(System.getProperty(LOG_LOGGER_NAME_PROPERTY, "false"));
	}
