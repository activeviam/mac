 ...
 *   <li>Apply the QFS formatter to enrich log records with the current thread and the current user.
 * </ul>
 *
 * <p>To load this class at the JVM startup time, add the following VM option: <br>
 * -Djava.util.logging.config.class=LoggingConfiguration
 *
 * <p>This configuration class is designed to be used programmatically, when deploying in the Jetty
 * server. When deploying in Apache Tomcat, use the logging.properties based configuration.
 *
 * @author Quartet FS
 */
public class LoggingConfiguration {
  ...
  public LoggingConfiguration() throws IOException {
    ...
    // Make sure to update the path to target existing directory or the logging configuration will
    // fail silently
